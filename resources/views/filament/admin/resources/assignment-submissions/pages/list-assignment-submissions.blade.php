<x-filament-panels::page>
    ...
    <style>
        ...
        .submissions-list-show .fa,
        .submissions-list-show .fas,
        .submissions-list-show .fa-solid {
            font-family: "Font Awesome 5 Free" !important;
            font-weight: 900 !important;
        }

        .submissions-list-show .far {
            font-family: "Font Awesome 5 Free" !important;
            font-weight: 400 !important;
        }

        .submissions-list-show .fab {
    ...
    <div class="submissions-list-show">
        <div class="ss-toolbar">
            <div class="ss-filters-group">
                <!-- No filters needed for assignment submissions table -->
            </div>
            
            <div class="ss-actions-group" style="display: flex; gap: 6px;">
                <!-- No create action for submissions table -->
            </div>
        </div>
        ...
        <div class="ss-card">
            ...
            <div class="ss-heading">
                <h2>បញ្ជីការដាក់ស្នើកិច្ចការ</h2>
            </div>
