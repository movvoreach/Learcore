<x-filament-panels::page>
    ...
    <style>
        ...
        .attendances-list-show .fa,
        .attendances-list-show .fas,
        .attendances-list-show .fa-solid {
            font-family: "Font Awesome 5 Free" !important;
            font-weight: 900 !important;
        }

        .attendances-list-show .far {
            font-family: "Font Awesome 5 Free" !important;
            font-weight: 400 !important;
        }

        .attendances-list-show .fab {
    ...
    <div class="attendances-list-show">
        <div class="ss-toolbar">
            <div class="ss-filters-group">
                <!-- No filters needed for attendances table -->
            </div>
            ...
            <div class="ss-actions-group" style="display: flex; gap: 6px;">
                @if (\App\Filament\Admin\Resources\Attendances\AttendanceResource::canCreate())
                    ...
                    <button class="ss-tool" type="button" title="បង្កើតវត្តមានរហ័ស" wire:click="mountAction('quickCreateAttendance')" style="background-color: #22c55e;">
