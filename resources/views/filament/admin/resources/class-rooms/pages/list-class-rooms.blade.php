<x-filament-panels::page>
    ...
    <style>
        ...
        .classrooms-list-show .fa,
        .classrooms-list-show .fas,
        .classrooms-list-show .fa-solid {
            font-family: "Font Awesome 5 Free" !important;
            font-weight: 900 !important;
        }

        .classrooms-list-show .far {
            font-family: "Font Awesome 5 Free" !important;
            font-weight: 400 !important;
        }

        .classrooms-list-show .fab {
    ...
    <div class="classrooms-list-show">
        <div class="ss-toolbar">
            <div class="ss-filters-group">
                <!-- No filters needed for class rooms table -->
            </div>
