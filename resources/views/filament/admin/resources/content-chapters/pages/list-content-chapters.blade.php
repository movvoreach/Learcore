<x-filament-panels::page>
    ...
    <style>
        ...
        .chapters-list-show .fa,
        .chapters-list-show .fas,
        .chapters-list-show .fa-solid {
            font-family: "Font Awesome 5 Free" !important;
            font-weight: 900 !important;
        }

        .chapters-list-show .far {
            font-family: "Font Awesome 5 Free" !important;
            font-weight: 400 !important;
        }

        .chapters-list-show .fab {
    ...
    <div class="chapters-list-show">
        <div class="ss-toolbar">
            <div class="ss-filters-group">
                <!-- No filters needed for content chapters table -->
            </div>
