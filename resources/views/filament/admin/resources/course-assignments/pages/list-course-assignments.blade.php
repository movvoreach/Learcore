<x-filament-panels::page>
    ...
    <style>
        ...
        .assignments-list-show .fa,
        .assignments-list-show .fas,
        .assignments-list-show .fa-solid {
            font-family: "Font Awesome 5 Free" !important;
            font-weight: 900 !important;
        }

        .assignments-list-show .far {
            font-family: "Font Awesome 5 Free" !important;
            font-weight: 400 !important;
        }

        .assignments-list-show .fab {
    ...
    <div class="assignments-list-show">
        <div class="ss-toolbar">
            <div class="ss-filters-group">
                <!-- No filters needed for assignments table -->
            </div>
