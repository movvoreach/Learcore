<x-filament-panels::page>
    ...
    <style>
        ...
        .departments-list-show .fa,
        .departments-list-show .fas,
        .departments-list-show .fa-solid {
            font-family: "Font Awesome 5 Free" !important;
            font-weight: 900 !important;
        }

        .departments-list-show .far {
            font-family: "Font Awesome 5 Free" !important;
            font-weight: 400 !important;
        }

        .departments-list-show .fab {
    ...
    <div class="departments-list-show">
        <div class="ss-toolbar">
            <div class="ss-filters-group">
                <!-- No filters needed for departments table -->
            </div>
