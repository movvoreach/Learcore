<x-filament-panels::page>
    ...
    <style>
        ...
        .permissions-list-show .fa,
        .permissions-list-show .fas,
        .permissions-list-show .fa-solid {
            font-family: "Font Awesome 5 Free" !important;
            font-weight: 900 !important;
        }

        .permissions-list-show .far {
            font-family: "Font Awesome 5 Free" !important;
            font-weight: 400 !important;
        }

        .permissions-list-show .fab {
    ...
    <div class="permissions-list-show">
        <div class="ss-toolbar">
            <div class="ss-filters-group">
                <!-- No filters needed for permissions table -->
            </div>
