<x-filament-panels::page>
    ...
    <style>
        ...
        .semesters-list-show .far {
            font-family: "Font Awesome 5 Free" !important;
            font-weight: 400 !important;
        }

        .semesters-list-show .fab {
        ...
        <div class="ss-toolbar">
            ...
            <div class="ss-actions-group" style="display: flex; gap: 6px;">
                @if (\App\Filament\Admin\Resources\Semesters\SemesterResource::canCreate())
                    <a class="ss-tool" href="{{ \App\Filament\Admin\Resources\Semesters\SemesterResource::getUrl('create') }}" title="បញ្ចូលឆមាស">
                        <i class="fa fa-plus-circle"></i>
                    </a>
                    <button class="ss-tool" type="button" title="បង្កើតឆមាសជាក្រុម" wire:click="mountAction('create_semesters_group')" style="background-color: #4b5563;">
