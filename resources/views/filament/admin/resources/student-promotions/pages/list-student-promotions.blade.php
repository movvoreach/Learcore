<x-filament-panels::page>
    ...
    <style>
        ...
        .promotions-list-show .far {
            font-family: "Font Awesome 5 Free" !important;
            font-weight: 400 !important;
        }

        .promotions-list-show .fab {
        ...
        <div class="ss-toolbar">
            ...
            <div class="ss-actions-group" style="display: flex; gap: 6px;">
                @if (\App\Filament\Admin\Resources\StudentPromotions\StudentPromotionResource::canCreate())
                    <button class="ss-tool" type="button" title="ដំឡើងឆមាសនិស្សិត" wire:click="mountAction('create')">
                        <i class="fa fa-plus-circle"></i>
                    </button>
                    <button class="ss-tool" type="button" title="ដំឡើងឆមាសជាក្រុម" wire:click="mountAction('promote_group')" style="background-color: #4b5563;">
                        <i class="fa fa-users"></i>
                    </button>
                    <button class="ss-tool" type="button" title="Promote Group Next" wire:click="mountAction('promote_group_to_next')" style="background-color: #0d9488;">
