<x-filament-panels::page>
    ...
    <style>
        ...
        .teachers-list-show .fa,
        .teachers-list-show .fas,
        .teachers-list-show .fa-solid {
            font-family: "Font Awesome 5 Free" !important;
            font-weight: 900 !important;
        }

        .teachers-list-show .far {
            font-family: "Font Awesome 5 Free" !important;
            font-weight: 400 !important;
        }

        .teachers-list-show .fab {
    ...
    <div class="teachers-list-show">
        <div class="ss-toolbar">
            <div class="ss-filters-group">
                <!-- No filters needed for teachers table -->
            </div>
            
            <div class="ss-actions-group" >
                @if (\App\Filament\Admin\Resources\Teachers\TeacherResource::canCreate())
                    <a class="ss-tool" href="{{ \App\Filament\Admin\Resources\Teachers\TeacherResource::getUrl('create') }}" title="បញ្ចូលគ្រូបង្រៀន">
